...
public abstract class AbstractNestablePropertyAccessor extends AbstractPropertyAccessor {
   ...
   protected AbstractNestablePropertyAccessor(Class<?> clazz) {
      registerDefaultEditors();
      setWrappedInstance(ArtifactUtils.instantiateClass(clazz));
   }
   ...
   public void setWrappedInstance(Object object, @Nullable String nestedPath, @Nullable Object rootObject) {
      ...
      AssertUtils.notNull(this.wrappedObject, "Target object must not be null");
   ...
   public final Object getWrappedInstance() {
      AssertUtils.state(this.wrappedObject != null, "No wrapped object");
   ...
   public final Object getRootInstance() {
      AssertUtils.state(this.rootObject != null, "No root object");
   ...
   @Override
   public void setPropertyValue(String propertyName, @Nullable Object value) throws ArtifactsException {
   ...
   protected void setPropertyValue(PropertyTokenHolder tokens, PropertyValue pv) throws ArtifactsException {
      if (tokens.keys != null) {
   ...
   private void processKeyedProperty(PropertyTokenHolder tokens, PropertyValue pv) {
      ...
      AssertUtils.state(tokens.keys != null, "No token keys");
   ...
   @Override
   @Nullable
   public Class<?> getPropertyType(String propertyName) throws ArtifactsException {
      try {
   ...
   @Override
   @Nullable
   public TypeDescriptor getPropertyTypeDescriptor(String propertyName) throws ArtifactsException {
      try {
   ...
   @Override
   @Nullable
   public Object getPropertyValue(String propertyName) throws ArtifactsException {
      AbstractNestablePropertyAccessor nestedPa = getPropertyAccessorForPropertyPath(propertyName);
      PropertyTokenHolder tokens = getPropertyNameTokens(getFinalPath(nestedPa, propertyName));
   ...
   @SuppressWarnings("unchecked")
   @Nullable
   protected Object getPropertyValue(PropertyTokenHolder tokens) throws ArtifactsException {
    ...
    * @throws ArtifactsException in case of introspection failure
    */
   @Nullable
   protected PropertyHandler getPropertyHandler(String propertyName) throws ArtifactsException {
   ...
   private Object growArrayIfNecessary(Object array, int index, String name) {
      ...
      if (index >= length && index < this.autoGrowCollectionLimit) {
         ...
         AssertUtils.state(defaultValue != null, "Default value must not be null");
         return defaultValue;
      }
      else {
         return array;
   ...
   private Object newValue(Class<?> type, @Nullable TypeDescriptor desc, String name) {
      try {
         if (type.isArray()) {
            ...
            return ArtifactUtils.instantiateClass(ctor);
         }
      }
      catch (Throwable ex) {
