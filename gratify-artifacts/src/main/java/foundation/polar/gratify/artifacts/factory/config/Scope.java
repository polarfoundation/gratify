...
/**
 * Strategy interface used by a {@link ConfigurableArtifactFactory},
 * representing a target scope to hold bean instances in.
 * This allows for extending the ArtifactFactory's standard scopes
 * {@link ConfigurableArtifactFactory#SCOPE_SINGLETON "singleton"} and
 * {@link ConfigurableArtifactFactory#SCOPE_PROTOTYPE "prototype"}
 * with custom further scopes, registered for a
 * {@link ConfigurableArtifactFactory#registerScope(String, Scope) specific key}.
 *
 * <p>{@link foundation.polar.gratify.context.ApplicationContext} implementations
 * such as a {@link foundation.polar.gratify.web.context.WebApplicationContext}
 * may register additional standard scopes specific to their environment,
 * e.g. {@link foundation.polar.gratify.web.context.WebApplicationContext#SCOPE_REQUEST "request"}
 * and {@link foundation.polar.gratify.web.context.WebApplicationContext#SCOPE_SESSION "session"},
 ...
 * the containing ArtifactFactory), with any number of threads accessing
 ...
 * @see foundation.polar.gratify.aop.scope.ScopedProxyFactoryArtifact
 * @see foundation.polar.gratify.web.context.request.RequestScope
 * @see foundation.polar.gratify.web.context.request.SessionScope
 */
public interface Scope {
   /**
    * Return the object with the given name from the underlying scope,
    * {@link foundation.polar.gratify.artifacts.factory.ObjectFactory#getObject() creating it}
    ...
    * (DisposableArtifact, destroy-method, DestructionAwareArtifactPostProcessor).
    ...
    * @see foundation.polar.gratify.artifacts.factory.support.AbstractArtifactDefinition#getDestroyMethodName()
