 ...
 *
 * <p>Used by {@link AutowiredAnnotationArtifactPostProcessor},
 * {@link foundation.polar.gratify.context.annotation.CommonAnnotationArtifactPostProcessor} and
 * {@link foundation.polar.gratify.orm.jpa.support.PersistenceAnnotationArtifactPostProcessor}.
 *
...
public class InjectionMetadata {
   ...
   public abstract static class InjectedElement {
       ...
       */
      protected void inject(Object target, @Nullable String requestingArtifactName, @Nullable PropertyValues pvs)
         throws Throwable {

         if (this.isField) {
            Field field = (Field) this.member;
            ReflectionUtils.makeAccessible(field);
            field.set(target, getResourceToInject(target, requestingArtifactName));
         }
         else {
            ...
            try {
               ...
               method.invoke(target, getResourceToInject(target, requestingArtifactName));
            }
       ...
       */
      @Nullable
      protected Object getResourceToInject(Object target, @Nullable String requestingArtifactName) {
         return null;
      }
