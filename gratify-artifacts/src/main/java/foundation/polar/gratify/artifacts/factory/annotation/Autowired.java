 ...
 * Gratify's dependency injection facilities. This is an alternative to the JSR-330
 ...
 * to autowire when used as a Gratify bean. Furthermore, if the {@code required}
 ...
 * Artifact property setter methods are effectively just a special case of such a general
 * config method. Such config methods do not have to be public.
 *
 * <h3>Autowired Parameters</h3>
 * <p>Although {@code @Autowired} can technically be declared on individual method
 * or constructor parameters since Gratify Framework 5.0, most parts of the
 * framework ignore such declarations. The only part of the core Gratify Framework
 ...
 * {@link java.util.Optional} or, as of Gratify Framework 5.0, also as {@code @Nullable}
 ...
 * {@link foundation.polar.gratify.core.Ordered Ordered} and
 * {@link foundation.polar.gratify.core.annotation.Order @Order} values of the target
 ...
 *
 * <h3>Not supported in {@code ArtifactPostProcessor} or {@code ArtifactFactoryPostProcessor}</h3>
 * <p>Note that actual injection is performed through a
 * {@link foundation.polar.gratify.artifacts.factory.config.ArtifactPostProcessor
 * ArtifactPostProcessor} which in turn means that you <em>cannot</em>
