...
import foundation.polar.gratify.core.GratifyProperties;
import foundation.polar.gratify.core.convert.TypeDescriptor;
import foundation.polar.gratify.core.io.support.GratifyFactoriesLoader;
...
public final class CachedIntrospectionResults {
   ...
   private static List<ArtifactInfoFactory> beanInfoFactories = GratifyFactoriesLoader.loadFactories(
      ArtifactInfoFactory.class, CachedIntrospectionResults.class.getClassLoader());
    ...
    */
   static CachedIntrospectionResults forClass(Class<?> beanClass) throws ArtifactsException {
    ...
    * @throws ArtifactsException in case of introspection failure
    */
   private CachedIntrospectionResults(Class<?> beanClass) throws ArtifactsException {
      try {
   ...
   private PropertyDescriptor buildGenericTypeAwarePropertyDescriptor(Class<?> beanClass, PropertyDescriptor pd) {
      try {
         ...
         throw new FatalArtifactException("Failed to re-introspect class [" + beanClass.getName() + "]", ex);
      }
   }
