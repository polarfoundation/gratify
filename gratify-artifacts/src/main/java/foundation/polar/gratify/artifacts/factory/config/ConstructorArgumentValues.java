...
public class ConstructorArgumentValues {
   ...
   public void addIndexedArgumentValue(int index, ValueHolder newValue) {
      AssertUtils.isTrue(index >= 0, "Index must not be negative");
      AssertUtils.notNull(newValue, "ValueHolder must not be null");
    ...
    * if demanded: see {@link foundation.polar.gratify.artifacts.Mergeable}.
    ...
    * with the current value if demanded: see {@link foundation.polar.gratify.artifacts.Mergeable}.
    * @param newValue the argument value in the form of a ValueHolder
    */
    ...
    */
   public static class ValueHolder implements ArtifactMetadataElement {
