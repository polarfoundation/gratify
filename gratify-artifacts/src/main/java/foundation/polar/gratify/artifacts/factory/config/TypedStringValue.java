 ...
 * @see foundation.polar.gratify.artifacts.MutablePropertyValues#addPropertyValue
 */
public class TypedStringValue implements ArtifactMetadataElement {
   @Nullable
    ...
    * for example in ArtifactFactoryPostProcessors.
    */
   ...
   public void setTargetType(Class<?> targetType) {
      AssertUtils.notNull(targetType, "'targetType' must not be null");
