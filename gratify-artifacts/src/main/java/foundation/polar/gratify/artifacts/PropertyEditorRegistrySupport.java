...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
    ...
    * such as {@link foundation.polar.gratify.artifacts.propertyeditors.StringArrayPropertyEditor}.
    ...
    * ArtifactWrapperImpl overrides this with the standard {@code getPropertyType}
    * method as defined by the ArtifactWrapper interface.
    ...
    * @see ArtifactWrapper#getPropertyType(String)
    */
   @Nullable
