...
import foundation.polar.gratify.artifacts.ArtifactWrapperImpl;
 ...
 * evaluating the specified bean property via a ArtifactWrapper.
 *
 * @author Juergen Hoeller
 * @author Jean-Pierre Pawlak
 *
 * @param <T> the type of objects that may be compared by this comparator
 * @see foundation.polar.gratify.artifacts.ArtifactWrapper
 */
public class PropertyComparator<T> implements Comparator<T> {
   ...
   private final ArtifactWrapperImpl beanWrapper = new ArtifactWrapperImpl(false);
    ...
    */
   public static void sort(List<?> source, SortDefinition sortDefinition) throws ArtifactsException {
    ...
    * @throws java.lang.IllegalArgumentException in case of a missing propertyName
    */
   public static void sort(Object[] source, SortDefinition sortDefinition) throws ArtifactsException {
      if (StringUtils.hasText(sortDefinition.getProperty())) {
