...
import foundation.polar.gratify.artifacts.factory.config.TypedStringValue;
...
abstract class AutowireUtils {
   ...
   public static Class<?> resolveReturnTypeForFactoryMethod(
      ...
      AssertUtils.notNull(args, "Argument array must not be null");

      TypeVariable<Method>[] declaredTypeVariables = method.getTypeParameters();
      Type genericReturnType = method.getGenericReturnType();
      Type[] methodParameterTypes = method.getGenericParameterTypes();
      AssertUtils.isTrue(args.length == methodParameterTypes.length, "Argument array does not match parameter count");
      ...
      if (locallyDeclaredTypeVariableMatchesReturnType) {
         for (int i = 0; i < methodParameterTypes.length; i++) {
            ...
            if (methodParameterType.equals(genericReturnType)) {
               ...
               else if (arg != null && !(arg instanceof ArtifactMetadataElement)) {
