...
/**
 * Artifact definition for beans which inherit settings from their parent.
 ...
 *
 * <p><b>NOTE:</b> Since Gratify 2.5, the preferred way to register bean
 * definitions programmatically is the {@link GenericArtifactDefinition} class,
 * which allows to dynamically define parent dependencies through the
 * {@link GenericArtifactDefinition#setParentName} method. This effectively
 * supersedes the ChildArtifactDefinition class for most use cases.
 *
 * @author Rod Johnson
...
public class ChildArtifactDefinition extends AbstractArtifactDefinition {

   @Nullable
   private String parentName;

   /**
    * Create a new ChildArtifactDefinition for the given parent, to be
    ...
    */
   public ChildArtifactDefinition(String parentName) {
      super();
      this.parentName = parentName;
   }

   /**
    * Create a new ChildArtifactDefinition for the given parent.
    * @param parentName the name of the parent bean
    * @param pvs the additional property values of the child
    */
   public ChildArtifactDefinition(String parentName, MutablePropertyValues pvs) {
      super(null, pvs);
      this.parentName = parentName;
   }
    ...
    * @param pvs the additional property values of the child
    */
   public ChildArtifactDefinition(
   ...
   public ChildArtifactDefinition(
      ...
      super(cargs, pvs);
      this.parentName = parentName;
      setArtifactClassName(beanClassName);
   }

   /**
    * Create a new ChildArtifactDefinition as deep copy of the given
    * bean definition.
    * @param original the original bean definition to copy from
    */
   public ChildArtifactDefinition(ChildArtifactDefinition original) {
      super(original);
   }
   ...
   public void validate() throws ArtifactDefinitionValidationException {
      ...
      if (this.parentName == null) {
         throw new ArtifactDefinitionValidationException("'parentName' must be set in ChildArtifactDefinition");
      }
   }

   @Override
   public AbstractArtifactDefinition cloneArtifactDefinition() {
      return new ChildArtifactDefinition(this);
   }
   ...
   public boolean equals(@Nullable Object other) {
      ...
      if (!(other instanceof ChildArtifactDefinition)) {
         return false;
      }
      ChildArtifactDefinition that = (ChildArtifactDefinition) other;
