...
public interface PropertyAccessor {
    ...
    */
   Class<?> getPropertyType(String propertyName) throws ArtifactsException;
    ...
    * accessor method failed
    */
   TypeDescriptor getPropertyTypeDescriptor(String propertyName) throws ArtifactsException;
    ...
    * accessor method failed
    */
   Object getPropertyValue(String propertyName) throws ArtifactsException;
    ...
    */
   void setPropertyValue(String propertyName, Object value) throws ArtifactsException;
    ...
    * accessor method failed or a type mismatch occurred
    */
   void setPropertyValue(PropertyValue pv) throws ArtifactsException;
    ...
    * @throws InvalidPropertyException if there is no such property or
    * if the property isn't writable
    * @throws PropertyArtifactUpdateException if one or more PropertyAccessExceptions
    * occurred for specific properties during the batch update. This exception bundles
    * all individual PropertyAccessExceptions. All other properties will have been
    * successfully updated.
    */
   void setPropertyValues(Map<?, ?> map) throws ArtifactsException;
    ...
    * {@link PropertyArtifactUpdateException} containing all the individual errors.
    ...
    */
   void setPropertyValues(PropertyValues pvs) throws ArtifactsException;
