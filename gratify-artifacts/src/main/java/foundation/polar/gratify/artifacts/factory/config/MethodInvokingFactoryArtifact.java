...
/**
 * {@link FactoryArtifact} which returns a value which is the result of a static or instance
 ...
 * {@link MethodInvokingArtifact} instead, which avoids the type determination and
 * lifecycle limitations that this {@link MethodInvokingFactoryArtifact} comes with.</b>
 *
 ...
 * all properties have been set, as per the InitializingArtifact contract.
 *
 ...
 *
 * <pre class="code">
 * &lt;bean id="myObject" class="foundation.polar.gratify.beans.factory.config.MethodInvokingFactoryArtifact">
 ...
 *
 * <pre class="code">
 * &lt;bean id="sysProps" class="foundation.polar.gratify.beans.factory.config.MethodInvokingFactoryArtifact">
 *   &lt;property name="targetClass" value="java.lang.System"/>
 *   &lt;property name="targetMethod" value="getProperties"/>
 * &lt;/bean>
 *
 * &lt;bean id="javaVersion" class="foundation.polar.gratify.beans.factory.config.MethodInvokingFactoryArtifact">
 ...
 *
 * @see MethodInvokingArtifact
 * @see foundation.polar.gratify.util.MethodInvoker
 */
public class MethodInvokingFactoryArtifact
   extends MethodInvokingArtifact implements FactoryArtifact<Object> {
