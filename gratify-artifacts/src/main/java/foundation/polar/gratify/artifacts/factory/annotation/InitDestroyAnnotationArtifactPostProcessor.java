...
/**
 * {@link foundation.polar.gratify.artifacts.factory.config.ArtifactPostProcessor} implementation
 * that invokes annotated init and destroy methods. Allows for an annotation
 * alternative to Gratify's {@link foundation.polar.gratify.artifacts.factory.InitializingArtifact}
 * and {@link foundation.polar.gratify.artifacts.factory.DisposableArtifact} callback interfaces.
 *
 ...
 *
 * <p>Gratify's {@link foundation.polar.gratify.context.annotation.CommonAnnotationArtifactPostProcessor}
...
public class InitDestroyAnnotationArtifactPostProcessor
   implements DestructionAwareArtifactPostProcessor, MergedArtifactDefinitionPostProcessor, PriorityOrdered, Serializable {

   private final transient LifecycleMetadata emptyLifecycleMetadata =
      new LifecycleMetadata(Object.class, Collections.emptyList(), Collections.emptyList()) {
         @Override
         public void checkConfigMembers(RootArtifactDefinition beanDefinition) {
         }
         @Override
   ...
   @Override
   public Object postProcessBeforeInitialization(Object bean, String beanName) throws ArtifactsException {
      LifecycleMetadata metadata = findLifecycleMetadata(bean.getClass());
      try {
         metadata.invokeInitMethods(bean, beanName);
      }
      catch (InvocationTargetException ex) {
         throw new ArtifactCreationException(beanName, "Invocation of init method failed", ex.getTargetException());
      }
      catch (Throwable ex) {
         throw new ArtifactCreationException(beanName, "Failed to invoke init method", ex);
      }
      return bean;
   }

   @Override
   public Object postProcessAfterInitialization(Object bean, String beanName) throws ArtifactsException {
      return bean;
   }

   @Override
   public void postProcessBeforeDestruction(Object bean, String beanName) throws ArtifactsException {
      LifecycleMetadata metadata = findLifecycleMetadata(bean.getClass());
      try {
