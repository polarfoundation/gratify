...
public abstract class MergedAnnotationSelectors {
   ...
   public static <A extends java.lang.annotation.Annotation> MergedAnnotationSelector<A> nearest() {
    ...
    */
   @SuppressWarnings("unchecked")
   public static <A extends java.lang.annotation.Annotation> MergedAnnotationSelector<A> firstDirectlyDeclared() {
    ...
    */
   private static class Nearest implements MergedAnnotationSelector<java.lang.annotation.Annotation> {
      @Override
      public boolean isBestCandidate(MergedAnnotation<java.lang.annotation.Annotation> annotation) {
         return annotation.getDistance() == 0;
      }

      @Override
      public MergedAnnotation<java.lang.annotation.Annotation> select(
         MergedAnnotation<java.lang.annotation.Annotation> existing, MergedAnnotation<java.lang.annotation.Annotation> candidate) {
    ...
    * annotation.
    */
   private static class FirstDirectlyDeclared implements MergedAnnotationSelector<java.lang.annotation.Annotation> {
      ...
      @Override
      public MergedAnnotation<java.lang.annotation.Annotation> select(
         MergedAnnotation<java.lang.annotation.Annotation> existing, MergedAnnotation<Annotation> candidate) {
