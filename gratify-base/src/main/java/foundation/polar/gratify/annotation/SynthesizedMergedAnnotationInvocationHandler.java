...
/**
 * {@link InvocationHandler} for an {@link java.lang.annotation.Annotation} that Spring has
...
final class SynthesizedMergedAnnotationInvocationHandler<A extends Annotation>
   ...
   private SynthesizedMergedAnnotationInvocationHandler(MergedAnnotation<A> annotation, Class<A> type) {
      AssertUtils.notNull(annotation, "MergedAnnotation must not be null");
      AssertUtils.notNull(type, "Type must not be null");
      AssertUtils.isTrue(type.isAnnotation(), "Type must be an annotation");
