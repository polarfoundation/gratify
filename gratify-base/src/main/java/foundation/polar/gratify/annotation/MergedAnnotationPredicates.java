...
public class MergedAnnotationPredicates {
    ...
    */
   public static <A extends java.lang.annotation.Annotation> Predicate<MergedAnnotation<? extends A>> typeIn(String... typeNames) {
    ...
    * @return a {@link Predicate} to test the annotation type
    */
   public static <A extends java.lang.annotation.Annotation> Predicate<MergedAnnotation<? extends A>> typeIn(Class<?>... types) {
    ...
    * @return a {@link Predicate} to test the annotation type
    */
   public static <A extends java.lang.annotation.Annotation> Predicate<MergedAnnotation<? extends A>> typeIn(Collection<?> types) {
    ...
    * values
    */
   public static <A extends java.lang.annotation.Annotation> Predicate<MergedAnnotation<A>> firstRunOf(
    ...
    * extracted key
    */
   public static <A extends java.lang.annotation.Annotation, K> Predicate<MergedAnnotation<A>> unique(
    ...
    */
   private static class FirstRunOfPredicate<A extends java.lang.annotation.Annotation>
      ...
      FirstRunOfPredicate(Function<? super MergedAnnotation<A>, ?> valueExtractor) {
         AssertUtils.notNull(valueExtractor, "Value extractor must not be null");
   ...
   private static class UniquePredicate<A extends Annotation, K> implements Predicate<MergedAnnotation<A>> {
      ...
      UniquePredicate(Function<? super MergedAnnotation<A>, K> keyExtractor) {
         AssertUtils.notNull(keyExtractor, "Key extractor must not be null");
