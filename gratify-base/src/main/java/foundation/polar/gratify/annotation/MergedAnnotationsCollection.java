...
public class MergedAnnotationsCollection implements MergedAnnotations {
   ...
   private MergedAnnotationsCollection(Collection<MergedAnnotation<?>> annotations) {
      AssertUtils.notNull(annotations, "Annotations must not be null");
      ...
      for (int i = 0; i < this.annotations.length; i++) {
         ...
         AssertUtils.notNull(annotation, "Annotation must not be null");
         AssertUtils.isTrue(annotation.isDirectlyPresent(), "Annotation must be directly present");
         AssertUtils.isTrue(annotation.getAggregateIndex() == 0, "Annotation must have aggregate index of zero");
   ...
   @Nullable
   private <A extends java.lang.annotation.Annotation> MergedAnnotation<A> find(Object requiredType,
                                                                                @Nullable Predicate<? super MergedAnnotation<A>> predicate,
                                                                                @Nullable MergedAnnotationSelector<A> selector) {
