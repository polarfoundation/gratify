...
final class TypeMappedAnnotations implements MergedAnnotations {
   ...
   static final MergedAnnotations NONE = new TypeMappedAnnotations(
      null, new java.lang.annotation.Annotation[0], RepeatableContainers.none(), AnnotationFilter.ALL);
   ...
   private TypeMappedAnnotations(@Nullable Object source, java.lang.annotation.Annotation[] annotations,
                                 RepeatableContainers repeatableContainers, AnnotationFilter annotationFilter) {
   ...
   @Override
   public <A extends java.lang.annotation.Annotation> boolean isPresent(Class<A> annotationType) {
   ...
   @Override
   public <A extends java.lang.annotation.Annotation> boolean isDirectlyPresent(Class<A> annotationType) {
      if (this.annotationFilter.matches(annotationType)) {
         return false;
      }
      return Boolean.TRUE.equals(scan(annotationType,
   ...
   @Override
   public <A extends java.lang.annotation.Annotation> MergedAnnotation<A> get(Class<A> annotationType) {
   ...
   @Override
   public <A extends java.lang.annotation.Annotation> MergedAnnotation<A> get(String annotationType) {
      return get(annotationType, null, null);
   }
   ...
   @Override
   public <A extends java.lang.annotation.Annotation> Stream<MergedAnnotation<A>> stream(Class<A> annotationType) {
   ...
   @Override
   public <A extends java.lang.annotation.Annotation> Stream<MergedAnnotation<A>> stream(String annotationType) {
      if (this.annotationFilter == AnnotationFilter.ALL) {
         return Stream.empty();
      }
      return StreamSupport.stream(spliterator(annotationType), false);
   ...
   @Override
   public Stream<MergedAnnotation<java.lang.annotation.Annotation>> stream() {
      if (this.annotationFilter == AnnotationFilter.ALL) {
         return Stream.empty();
      }
   ...
   @Override
   public Iterator<MergedAnnotation<java.lang.annotation.Annotation>> iterator() {
      if (this.annotationFilter == AnnotationFilter.ALL) {
   ...
   @Override
   public Spliterator<MergedAnnotation<java.lang.annotation.Annotation>> spliterator() {
      if (this.annotationFilter == AnnotationFilter.ALL) {
         return Collections.<MergedAnnotation<java.lang.annotation.Annotation>> emptyList().spliterator();
      }
      return spliterator(null);
   }

   private <A extends java.lang.annotation.Annotation> Spliterator<MergedAnnotation<A>> spliterator(@Nullable Object annotationType) {
   ...
   static MergedAnnotations from(@Nullable Object source, java.lang.annotation.Annotation[] annotations,
                                 RepeatableContainers repeatableContainers, AnnotationFilter annotationFilter) {
   ...
   private static boolean isMappingForType(AnnotationTypeMapping mapping,
      ...
      Class<? extends java.lang.annotation.Annotation> actualType = mapping.getAnnotationType();
   ...
   private static final class IsPresent implements AnnotationsProcessor<Object, Boolean> {
      ...
      public Boolean doWithAnnotations(Object requiredType, int aggregateIndex,
                                       @Nullable Object source, java.lang.annotation.Annotation[] annotations) {

         for (java.lang.annotation.Annotation annotation : annotations) {
            if (annotation != null) {
               Class<? extends java.lang.annotation.Annotation> type = annotation.annotationType();
               if (type != null && !this.annotationFilter.matches(type)) {
                  if (type == requiredType || type.getName().equals(requiredType)) {
                     return Boolean.TRUE;
                  }
                  java.lang.annotation.Annotation[] repeatedAnnotations =
    ...
    */
   private class MergedAnnotationFinder<A extends java.lang.annotation.Annotation>
      ...
      private MergedAnnotation<A> process(
         Object type, int aggregateIndex, @Nullable Object source, java.lang.annotation.Annotation annotation) {

         java.lang.annotation.Annotation[] repeatedAnnotations = repeatableContainers.findRepeatedAnnotations(annotation);
         if (repeatedAnnotations != null) {
   ...
   private class AggregatesCollector implements AnnotationsProcessor<Object, List<Aggregate>> {
      ...
      private Aggregate createAggregate(int aggregateIndex, @Nullable Object source, java.lang.annotation.Annotation[] annotations) {
         List<java.lang.annotation.Annotation> aggregateAnnotations = getAggregateAnnotations(annotations);
         return new Aggregate(aggregateIndex, source, aggregateAnnotations);
      }

      private List<java.lang.annotation.Annotation> getAggregateAnnotations(java.lang.annotation.Annotation[] annotations) {
         List<java.lang.annotation.Annotation> result = new ArrayList<>(annotations.length);
         addAggregateAnnotations(result, annotations);
         return result;
      }

      private void addAggregateAnnotations(List<java.lang.annotation.Annotation> aggregateAnnotations, java.lang.annotation.Annotation[] annotations) {
         for (java.lang.annotation.Annotation annotation : annotations) {
            if (annotation != null && !annotationFilter.matches(annotation)) {
               java.lang.annotation.Annotation[] repeatedAnnotations = repeatableContainers.findRepeatedAnnotations(annotation);
               if (repeatedAnnotations != null) {
   ...
   private static class Aggregate {
      ...
      private final List<java.lang.annotation.Annotation> annotations;

      private final AnnotationTypeMappings[] mappings;

      Aggregate(int aggregateIndex, @Nullable Object source, List<java.lang.annotation.Annotation> annotations) {
      ...
      @Nullable
      <A extends java.lang.annotation.Annotation> MergedAnnotation<A> createMergedAnnotationIfPossible(
