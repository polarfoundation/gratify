...
import foundation.polar.gratify.core.io.*;
 ...
 * target {@link foundation.polar.gratify.core.io.Resource}, or alternatively
 * may contain the special "{@code classpath*:}" prefix and/or
 * internal Ant-style regular expressions (matched using Spring's
 * {@link foundation.polar.gratify.utils.AntPathMatcher} utility).
 ...
 * @see foundation.polar.gratify.utils.AntPathMatcher
 * @see foundation.polar.gratify.core.io.ResourceLoader#getResource(String)
...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
    ...
    * @see foundation.polar.gratify.core.io.DefaultResourceLoader
    */
   ...
   public void setPathMatcher(PathMatcher pathMatcher) {
      AssertUtils.notNull(pathMatcher, "PathMatcher must not be null");
   ...
   public Resource[] getResources(String locationPattern) throws IOException {
      AssertUtils.notNull(locationPattern, "Location pattern must not be null");
    ...
    * @see #doFindPathMatchingJarResources
    * @see foundation.polar.gratify.utils.ResourceUtils#isJarURL
    */
