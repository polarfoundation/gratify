...
/**
 * Factory for collections that is aware of common Java and Gratify collection types.
 *
...
public final class CollectionFactory {
   ...
   public static <E> Collection<E> createCollection(Class<?> collectionType, @Nullable Class<?> elementType, int capacity) {
      AssertUtils.notNull(collectionType, "Collection type must not be null");
      if (collectionType.isInterface()) {
         ...
         AssertUtils.notNull(elementType, "Cannot create EnumSet for unknown element type");
         // Cast is necessary for compilation in Eclipse 4.4.1.
    ...
    * @see java.util.LinkedHashMap
    * @see java.util.TreeMap
    * @see foundation.polar.gratify.ds.LinkedMultiValueMap
    * @see java.util.EnumMap
    * @throws IllegalArgumentException if the supplied {@code mapType} is
   ...
   public static <K, V> Map<K, V> createMap(Class<?> mapType, @Nullable Class<?> keyType, int capacity) {
      AssertUtils.notNull(mapType, "Map type must not be null");
      if (mapType.isInterface()) {
         ...
         AssertUtils.notNull(keyType, "Cannot create EnumMap for unknown key type");
