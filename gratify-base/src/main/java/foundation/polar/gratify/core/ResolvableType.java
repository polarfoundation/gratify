...
import foundation.polar.gratify.core.SerializableTypeWrapper.FieldTypeProvider;
import foundation.polar.gratify.core.SerializableTypeWrapper.MethodParameterTypeProvider;
import foundation.polar.gratify.core.SerializableTypeWrapper.TypeProvider;
...
public class ResolvableType implements Serializable {
   ...
   private boolean isAssignableFrom(ResolvableType other, @Nullable Map<Type, Type> matchedBefore) {
      AssertUtils.notNull(other, "ResolvableType must not be null");
   ...
   public static ResolvableType forClass(Class<?> baseType, Class<?> implementationClass) {
      AssertUtils.notNull(baseType, "Base type must not be null");
   ...
   public static ResolvableType forClassWithGenerics(Class<?> clazz, Class<?>... generics) {
      ...
      AssertUtils.notNull(generics, "Generics array must not be null");
   ...
   public static ResolvableType forClassWithGenerics(Class<?> clazz, ResolvableType... generics) {
      ...
      AssertUtils.isTrue(variables.length == generics.length, "Mismatched number of generics specified");
   ...
   public static ResolvableType forArrayComponent(ResolvableType componentType) {
      AssertUtils.notNull(componentType, "Component type must not be null");
