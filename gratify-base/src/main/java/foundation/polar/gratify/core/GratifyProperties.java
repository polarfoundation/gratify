 ...
 * @see foundation.polar.gratify.env.AbstractEnvironment#IGNORE_GETENV_PROPERTY_NAME
 * @see foundation.polar.gratify.beans.CachedIntrospectionResults#IGNORE_BEANINFO_PROPERTY_NAME
 * @see foundation.polar.gratify.jdbc.core.StatementCreatorUtils#IGNORE_GETPARAMETERTYPE_PROPERTY_NAME
 * @see foundation.polar.gratify.test.context.cache.ContextCache#MAX_CONTEXT_CACHE_SIZE_PROPERTY_NAME
 */
