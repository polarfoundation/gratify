...
import foundation.polar.gratify.core.DecoratingProxy;
...
import foundation.polar.gratify.core.convert.converter.*;
import foundation.polar.gratify.core.convert.converter.GenericConverter.ConvertiblePair;
...
public class GenericConversionService implements ConfigurableConversionService {
   ...
   public Object convert(@Nullable Object source, @Nullable TypeDescriptor sourceType, TypeDescriptor targetType) {
      AssertUtils.notNull(targetType, "Target type to convert to cannot be null");
      if (sourceType == null) {
         AssertUtils.isTrue(source == null, "Source must be [null] if source type == [null]");
   ...
   private static class Converters {
      ...
      public void add(GenericConverter converter) {
         ...
         if (convertibleTypes == null) {
            AssertUtils.state(converter instanceof ConditionalConverter,
