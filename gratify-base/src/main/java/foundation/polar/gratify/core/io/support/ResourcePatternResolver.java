 ...
 *
 * <p>This is an extension to the {@link foundation.polar.gratify.core.io.ResourceLoader}
 * interface. A passed-in ResourceLoader (for example, an
 * {@link foundation.polar.gratify.di.ApplicationContext} passed in via
 * {@link foundation.polar.gratify.di.ResourceLoaderAware} when running in a context)
 ...
 * @see foundation.polar.gratify.di.ResourceLoaderAware
 */
public interface ResourcePatternResolver extends ResourceLoader {
    ...
    * @see foundation.polar.gratify.core.io.ResourceLoader#CLASSPATH_URL_PREFIX
    */
