...
public class FastByteArrayOutputStream extends OutputStream {
   ...
   public FastByteArrayOutputStream(int initialBlockSize) {
      AssertUtils.isTrue(initialBlockSize > 0, "Initial block size must be greater than 0");
   ...
   public void resize(int targetCapacity) {
      AssertUtils.isTrue(targetCapacity >= size(), "New capacity must not be smaller than current size");
