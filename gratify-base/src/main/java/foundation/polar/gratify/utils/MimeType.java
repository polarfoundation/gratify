...
import foundation.polar.gratify.ds.LinkedCaseInsensitiveMap;
...
public class MimeType implements Comparable<MimeType>, Serializable {
   ...
   public MimeType(String type, String subtype, @Nullable Map<String, String> parameters) {
      AssertUtils.hasLength(type, "'type' must not be empty");
      AssertUtils.hasLength(subtype, "'subtype' must not be empty");
      checkToken(type);
      checkToken(subtype);
   ...
   protected void checkParameters(String attribute, String value) {
      AssertUtils.hasLength(attribute, "'attribute' must not be empty");
      AssertUtils.hasLength(value, "'value' must not be empty");
    ...
    * (as supported by {@link foundation.polar.gratify.convert.ConversionService}.
