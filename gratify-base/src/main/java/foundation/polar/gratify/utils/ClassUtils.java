...
public abstract class ClassUtils {
    ...
    * although {@link foundation.polar.gratify.io.ClassPathResource} is usually
   ...
   public static Class<?> createCompositeInterface(Class<?>[] interfaces, @Nullable ClassLoader classLoader) {
      AssertUtils.notEmpty(interfaces, "Interface array must not be empty");
    ...
    * <p><b>NOTE:</b> In contrast to {@link foundation.polar.gratify.aop.support.AopUtils#getMostSpecificMethod},
    * this method does <i>not</i> resolve Java 5 bridge methods automatically.
    * Call {@link foundation.polar.gratify.BridgeMethodResolver#findBridgedMethod}
