...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
    ...
    * an {@link foundation.polar.gratify.context.ApplicationContextInitializer
    ...
    * @see foundation.polar.gratify.context.ApplicationContextInitializer
    */
   protected void customizePropertySources(MutablePropertySources propertySources) {
   }
   ...
   public void setActiveProfiles(String... profiles) {
      AssertUtils.notNull(profiles, "Profile array must not be null");
   ...
   protected boolean suppressGetenvAccess() {
      return GratifyProperties.getFlag(IGNORE_GETENV_PROPERTY_NAME);
   }
