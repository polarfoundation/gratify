 ...
 * foundation.polar.gratify.context.annotation.Configuration Configuration} classes that
 * the @{@link foundation.polar.gratify.context.annotation.PropertySource PropertySource}
 ...
 * @see foundation.polar.gratify.context.annotation.PropertySource
 */
public abstract class PropertySource<T> {
   ...
   public PropertySource(String name, T source) {
      AssertUtils.hasText(name, "Property source name must contain at least one character");
      AssertUtils.notNull(source, "Property source must not be null");
      this.name = name;
      this.source = source;
   }
    ...
    * @see foundation.polar.gratify.context.support.AbstractApplicationContext#initPropertySources()
    */
